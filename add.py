...
def songadd():
    ...
    add_list = [title, artist, album, genre, rlsyr]
    ...
    try:
        ...
        messagebox.showinfo('Success',"Song Data Added Successfully")

    except:
        messagebox.showinfo("Error","Can't Add Song Data Into File")
